    ...
    >
      ...
      <div className="mx-auto flex min-w-[300px] max-w-[400px] flex-col rounded-3xl shadow-[0px_0px_0px_1px_#00000020,0px_3px_8px_0px_#00000020,0px_10px_13px_9px_#00000008,0px_5px_4px_2px_#00000007]  ">
        ...
        <div className="flex flex-col  items-center rounded-b-3xl bg-[#ffffffd8]  px-16 py-12 backdrop-blur-3xl">
          ...
          <button
            className="align-center justify-middle group group mx-auto mt-4 inline-flex cursor-pointer flex-row items-center justify-center rounded-xl border border-transparent bg-[#9f9f9d31] px-10 py-2.5 align-middle text-xs font-normal text-[#696868] transition-all"
            onClick={resetErrorBoundary}
          >
            <HiRefresh className="mr-1 transition-all duration-300 group-hover:rotate-180" />{" "}
            Try again
          </button>
        </div>
      </div>
