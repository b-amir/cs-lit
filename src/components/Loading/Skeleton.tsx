...
export function HomeCategorySkeleton() {
  return (
    <div className="h-8/12 mx-auto mb-20 grid w-full justify-center px-3 gap-6 text-lg font-normal grid-cols-2 lg:grid-cols-3">
      <div className=" flex h-full w-full max-w-[calc(100vw-10vw)] animate-pulse flex-row items-center justify-center overflow-x-clip rounded-2xl border border-[#d5d9df33]  bg-[#d6e2f62c] px-6   text-[#29313d]  backdrop-blur-lg sm:mx-auto sm:max-w-[calc(40vw)] sm:bg-[#d6e2f60b] py-5 sm:py-9" />
      <div className=" flex h-full w-full max-w-[calc(100vw-10vw)] animate-pulse flex-row items-center justify-center overflow-x-clip rounded-2xl border border-[#d5d9df33]  bg-[#d6e2f62c] px-6   text-[#29313d]  backdrop-blur-lg sm:mx-auto sm:max-w-[calc(40vw)] sm:bg-[#d6e2f60b] py-5 sm:py-9" />
      <div className=" flex h-full w-full max-w-[calc(100vw-10vw)] animate-pulse flex-row items-center justify-center overflow-x-clip rounded-2xl border border-[#d5d9df33]  bg-[#d6e2f62c] px-6  text-[#29313d]  backdrop-blur-lg sm:mx-auto sm:max-w-[calc(40vw)] sm:bg-[#d6e2f60b] py-5 sm:py-9" />
      <div className=" flex h-full w-full max-w-[calc(100vw-10vw)] animate-pulse flex-row items-center justify-center overflow-x-clip rounded-2xl border border-[#d5d9df33]  bg-[#d6e2f62c] px-6   text-[#29313d]  backdrop-blur-lg sm:mx-auto sm:max-w-[calc(40vw)] sm:bg-[#d6e2f60b] py-5 sm:py-9" />
      <div className=" flex h-full w-full max-w-[calc(100vw-10vw)] animate-pulse flex-row items-center justify-center overflow-x-clip rounded-2xl border border-[#d5d9df33]  bg-[#d6e2f62c] px-6   text-[#29313d]  backdrop-blur-lg sm:mx-auto sm:max-w-[calc(40vw)] sm:bg-[#d6e2f60b] py-5 sm:py-9" />
