...
export function EditorSection({
  ...
  return (
    <div
      className={`text-dark-2 z-30 mx-auto flex w-full grow-0 flex-col items-center justify-center px-2 shadow-lg  backdrop-blur-md sm:px-10 lg:px-[16.666667%]  ${
        topicEditorState.shown
          ? "sticky bottom-0 h-full max-h-[calc(100vh-90px-1px)] bg-gray-5 pb-5 pt-7 shadow-[0px_-1px_6px_2px_#00000015,0px_0px_0px_1px_#00000030,0px_-11px_20px_2px_#00000005,0px_-20px_55px_0px_#00000005]"
          : "sticky bottom-[-200px] bg-gray-5 py-2 sm:pb-7 sm:pt-9"
      }`}
    >
      <FormTrigger
